...
const noHours = `<h5 class= "text-danger">No hay horas diponibles.</h5>`
...
function getRadioIntervaloHTML(intervalo) {
    ...
    return `<div class="custom-control custom-radio mb-3">
            <input type="radio" id="interval${iRadio}" name="scheduled_time" value="${intervalo.start}"  class="custom-control-input" require>
